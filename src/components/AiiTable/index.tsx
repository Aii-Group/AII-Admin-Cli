            ...
            <th style={thStyle} colSpan={computeColumnsLength + 1}>
              <div className="flex w-full batch-operation-th">
                ...
                <div className="flex justify-end px-10 w-1/2">
                  <Button className="primary-text-btn" type="text" icon={<Delete />} onClick={onBatchDelete}>
                    {t('Action.Batch_Delete')}
                  </Button>
                  <Button className="error-text-btn" type="text" icon={<DownloadFour />} onClick={onBatchExport}>
              ...
              <th colSpan={3} style={rightThStyle}>
                <div className="batch-operation-th">
                  <div className="text-right px-10">
                    <Button className="error-text-btn" type="text" icon={<Delete />} onClick={onBatchDelete}>
                      {t('Action.Batch_Delete')}
                    </Button>
                    <Button className="primary-text-btn" type="text" icon={<DownloadFour />} onClick={onBatchExport}>
                      {t('Action.Batch_Export')}
                    </Button>
                  </div>
                </div>
